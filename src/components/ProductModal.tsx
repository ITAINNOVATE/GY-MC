      ...
      <div className="modal-content glass-effect" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="modal-details">
            ...
            <p className="modal-price">{selectedProduct.price.toLocaleString()} F CFA</p>
            ...
            <div className="modal-actions">
              ...
              <a 
                href={`https://wa.me/2290166743493?text=Bonjour, je souhaite commander l'article : ${selectedProduct.name}`} 
                target="_blank" 
